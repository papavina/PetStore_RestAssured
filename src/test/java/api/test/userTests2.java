...
public class userTests2 {
	...
	public void testPostUser(){
		...
		Response response = UserEndPoints2.createUser(this.payload);
	...
	public void testUpdateUserByname(){
		...
		payload.setFirstName(faker.name().firstName());
		payload.setLastName(faker.name().lastName());
		Response response = UserEndPoints2.updateUser(this.payload.getUsername(), this.payload);
		response.then().log().all();
		...
		Response response_after= UserEndPoints2.readUser(this.payload.getUsername());
		response.then().log().all();
